...
if __name__ == '__main__':
    ...
    patient_record.write.format("redshift").option("url", "jdbc:redshift://default-workgroup.257240804294.us-east-1.redshift-serverless.amazonaws.com:5439/dev")\
        .option("dbtable", "public.patient_record")\
        .option("user", "admin")\
        .option("password", "Nepal123")\
        .option("tempdir", "s3a://capstonprojecttakeo/tmp/").option(
        "aws_iam_role", "arn:aws:iam::257240804294:role/RedShiftAdmin").mode("overwrite").save()